...
@section('content')
    <div class="table p-2 mt-5">
        <div class="fiturbutton p-3 d-flex flex-row-reverse">
            <button class="btn btn-primary" onclick="window.location='{{ url('/flowers/create') }}'"><i
                    ...
                    <tr>
                        ...
                        <td style="white-space: nowrap">
                            <button class="badge border-0 p-2 bg-warning"
                                onclick="window.location='{{ url('/flowers/' . $d->id . '/edit') }}'">
                                <i class="bi bi-pencil-square"></i>
                            </button>
                            <form action="/flowers/{{ $d->id }}" method="post" class="d-inline">
                                @method('delete')
                                @csrf
