    ...
    <div class="table p-2 mt-5">
        ...
        <div class="container px-5">
            <form action="/customers/{{ $data->id }}" method="post">
                ...
                <input name="name" class="form-control py-1 @error('name') is-invalid @enderror" type="text" value="{{ $data->name }}"
                    required>
                @error('name')
                ...
                <input name="address" class="form-control py-1 @error('address') is-invalid @enderror" type="text"
                ...
                <button type="button" class="btn btn-warning mx-3" onclick="window.location='{{ url('/customers') }}'">Kembali</button>
            </form>
